...
class RationalNumbersTest(unittest.TestCase):
    ...
    # Test addition
    def test_add_denom_cannot_be_zero(self):
        with self.assertRaises(ZeroDivisionError): Rational(1, 0) + Rational(2, 3)
    ...
    def test_divide_when_first_numerator_is_zero(self):
        self.assertEqual(Rational(0, 2) / Rational(1, 1), Rational(0, 2))

    def test_divide_when_second_numerator_is_zero(self):
        with self.assertRaises(ZeroDivisionError): Rational(1, 2) / Rational(0, 1)
